...
def register_routes(app):
    ...
    def create_user():
        ...
        if form.validate_on_submit():
            ...
            user = User(name=form.name.data.strip(), email=email, role=form.role.data)
    ...
    def equipment_list():
        ...
        statuses = [("available", "Disponible"), ("loaned", "Prestado"), ("maintenance", "Mantenimiento"), ("retired", "Retirado")]
